        ...
        JPanel panel2 = new JPanel() {
            ...
            public void paintComponent(Graphics g) {
                ...
                for (Connection wire : wires) {
                    ...
                    // make it so that when object one and object two are moved, the line moves with
                    // it.
                    g2d.setColor(Color.RED); // change this line below to change positioning.
                    // if(!isClicking){
                    // Line2D line = new Line2D.Double(wire.object1.getLabel().getX() +
                    // wire.object1.getLabel().getWidth()/2, wire.object1.getLabel().getY() +
                    // wire.object1.getLabel().getHeight()/2, wire.object2.getLabel().getX() +
                    // wire.object2.getLabel().getWidth()/2, wire.object2.getLabel().getY() +
                    // wire.object2.getLabel().getHeight()/2);
                    // wire.wire = line;
                    // }
                    g2d.draw(wire.wire);
                    // g2d.draw(wire.wire);
...
class Connection {
    ...
    public void realizeConnection(JPanel x) {
        ...
        g2d.setStroke(new BasicStroke(5));
        g2d.setColor(Color.RED); // change this line below to change positioning.
        Line2D line = new Line2D.Double(object1.getLabel().getX() + object1.getLabel().getWidth() / 2,
                object1.getLabel().getY() + object1.getLabel().getHeight() / 2,
                object2.getLabel().getX() + object2.getLabel().getWidth() / 2,
                object2.getLabel().getY() + object2.getLabel().getHeight() / 2);
        wire = line;
